...
Os dados da temperatura serão enviados para o broker que é o CloudMQTT. Ele poderá enviar esse dado em qualquer dispositivo e para visualizar precisará utilizar uma dashboard em um aplicativo.
<br><br>
